...
tempLayers = helperNnetNasnetlargeLayerNASNetLargeZeroPadding2dLayer("zero_padding2d_5",0,1,0,1,"in","out");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = helperNnetNasnetlargeLayerNASNetLargeZeroPadding2dLayer("zero_padding2d_6",0,1,0,1,"in","out");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = helperNnetNasnetlargeLayerNASNetLargeZeroPadding2dLayer("zero_padding2d_7",0,1,0,1,"in","out");
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = helperNnetNasnetlargeLayerNASNetLargeZeroPadding2dLayer("zero_padding2d_8",0,1,0,1,"in","out");
lgraph = addLayers(lgraph,tempLayers);
...
%Save Model
NasNet_Large_Model_1 = net;
save NasNet_Large_Model_1
